        ...
        while True:
            ...
            while '\n' in buffer:
                ...
                if line_count >= buffer_size:
                    ...
                    threading.Thread(target=calculate_psd, args=(X, sample_rate)).start()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--port', type=int, default=9001, help='TCP port number to connect to')
